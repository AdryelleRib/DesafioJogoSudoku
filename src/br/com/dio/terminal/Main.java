package br.com.dio.terminal;

import br.com.dio.terminal.model.Board;
import br.com.dio.terminal.model.Space;
...
import static br.com.dio.terminal.util.BoardTemplate.BOARD_TEMPLATE;
...
public class Main {
    ...
    private static void startGame(final Map<String, String> positions) {
        ...
        //Cria um tabuleiro vazio com 9 linhas e 9 colunas
    ...
    private static void clearGame() {
        ...
        if(confirm.equalsIgnoreCase("sim")){
            board.reset();
            System.out.println("Seu jogo foi resetado!");
        }
    }
    ...
    private static void finishGame() {
        ...
        if (board.gameIsFinished()){
            ...
            System.out.println("Seu jogo contém erros! Verifique seu board e tente novamente");
        } else {
